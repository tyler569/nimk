...
parser.add_option('-f', '--file', help='ISO to run (default ngos.iso)', default='nimos.iso')
...
parser.add_option('-v', '--video', action='store_true', help='Show video (default)', default=True)
parser.add_option('-V', '--no-video', action='store_false', help="Don't show video", dest='video')
